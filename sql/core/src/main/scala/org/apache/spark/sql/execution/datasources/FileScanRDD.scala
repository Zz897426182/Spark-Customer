...
//                "by recreating the Dataset/DataFrame involved.")
            logWarning("***** Here for the source code for a special change[begin] *****")
            logWarning("It is possible the underlying files have been updated. " +
              "You can explicitly invalidate the cache in Spark by " +
              "running 'REFRESH TABLE tableName' command in SQL or " +
              "by recreating the Dataset/DataFrame involved.", e)
            logWarning("***** Here for the source code for a special change[end] *****")
